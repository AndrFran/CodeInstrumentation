...
if __name__ == "__main__":
    if len(sys.argv) > 0:
        ...
        ast_dict = file_to_dict(sys.argv[1])#"D:\\projects\\tasks\\CodeInstrumentation\\ConsoleApplication1\\ConsoleApplication1\\pycparser-master\\examples\\c_files\\funky.c"
